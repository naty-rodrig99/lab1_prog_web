...
describe("TW1.1.4 sort(CB) recap exercise: sortDishes", function tw1_1_20() {
    ...
    it("compareDishesCB, export it and sortDishes from utilities.js to enable", function  tw1_1_20_1(){
    ...
    it("sort order should be: 'no known type', starter, main course, dessert (export sortDishes to enable)", function  tw1_1_20_2(){
