...
async function getPresenters(framework){
    return {
        search: (await getModule(`/src/${framework}/${X}searchPresenter.jsx`))?.Search,
        sidebar: (await getModule(`/src/${framework}/${X}sidebarPresenter.jsx`))?.Sidebar,
        details: (await getModule(`/src/${framework}/${X}detailsPresenter.jsx`))?.Details,
        summary: (await getModule(`/src/${framework}/${X}summaryPresenter.jsx`))?.Summary,
    };
}
...
async function testReact(theTest){
    ...
    const ReactRoot= (await getModule(`/src/reactjs/${X}ReactRoot.jsx`))?.ReactRoot;
